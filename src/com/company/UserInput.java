...
public class UserInput {
    public static void getInput(){
        ...
        int powerBallFive;
        int magicBallNum;
        ArrayList<Integer> powerBalls = new ArrayList<Integer>();
        ...
        if(yourInput.toLowerCase().equals("yes") || yourInput.toLowerCase().equals("y")){
            do{
                ...
                powerBalls.add(powerBallOne);
                powerBalls.add(powerBallTwo);
                powerBalls.add(powerBallThree);
                powerBalls.add(powerBallFour);
                powerBalls.add(powerBallFive);

                Collections.sort(powerBalls);



                System.out.println("Lottery numbers: " + powerBalls.get(0) + ", " + powerBalls.get(1) + ", " + powerBalls.get(2) + ", " + powerBalls.get(3) + ", " + powerBalls.get(4) + " Magic Number: " + magicBallNum );
